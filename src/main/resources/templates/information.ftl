                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${exp.dorm}</td>
                                        <td>
                                            <#if exp.orderStatus==0>待接受</#if>
                                            <#if exp.orderStatus==1||exp.orderStatus==2>待送达</#if>
                                            <#if exp.orderStatus==3>待支付</#if>
                                            <#if exp.orderStatus==4>已完成</#if>
                                            <#if exp.orderStatus==5>已取消</#if>
                                        </td>
                                        <#--<td class="action-td">-->
...
<div class="sub">
	...
	<#assign no=number>
		<#if (no < 1)>
			<a href="#">上一页</a>
        <#else>
			<a href="/allExpress?page=${no-1}">上一页</a>
        </#if>
		<#if (no == pages-1)>
			<a href="#">下一页</a>
        <#else>
			<a href="/allExpress?page=${no+1}">下一页</a>
        </#if>
